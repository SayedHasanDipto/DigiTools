                ...
                <footer className="footer max-sm:justify-center max-sm:justify-items-center sm:footer-horizontal text-white pt-32 pb-20">
                    ...
                    <nav>
                        ...
                        <div className='flex gap-4'>
                            <div className='flex border rounded-full items-center justify-center w-10 h-10 gap-3 bg-white text-black'>
                                <a className="link link-hover"><RiInstagramFill className='w-5 h-5' /></a>
                            </div>
                            <div className='flex border rounded-full items-center justify-center w-10 h-10 gap-3 bg-white text-black'>
                                <a className="link link-hover"><FaFacebookSquare className='w-5 h-5' /></a>
                            </div>
                            <div className='flex border rounded-full items-center justify-center w-10 h-10 gap-3 bg-white text-black'>
