    ...
    return (
        <div className="hero max-w-7xl mx-auto flex justify-between items-center min-h-0 lg:min-h-screen h-auto py-20 lg:py-0 manrope">
            <div>
                ...
                <h1 className='text-7xl max-sm:text-xl max-sm:text-[3rem] max-sm:w-[25rem] max-sm:text-center font-extrabold text-[#101727] w-2xl leading-20 mb-4'>Supercharge Your Digital Workflow</h1>
                <p className='text-lg w-lg leading-8 max-sm:w-[22rem] max-sm:mx-auto max-sm:text-lg'>
