...
const ToolsCard = ({ datas }) => {
    console.log(datas);
    return (
        <div>
            <div className="card w-96 bg-base-100 shadow-sm rounded-2xl">
                <div className="card-body space-y-4">
                    <span className="badge badge-xs badge-warning">{datas.tag}</span>
                    ...
                    <div className="mt-6">
                        <button className="btn btn-secondary rounded-full btn-block">Subscribe</button>
                    </div>
                </div>
            </div>
        </div>
